...
<div class="w3-container  w3-padding-large w3-margin" >
  <p><?php                  $link = mysqli_connect("127.0.0.1", "root", "", "register");
							...
							$n= mysqli_query($link,"select des from n2 where level = '$l'");
							$n = implode(mysqli_fetch_array($n,MYSQLI_ASSOC));
							 echo  "<h3>  $n   </h3>";
							?></p>
</div>
...
<?php 
							...
							$n = implode(mysqli_fetch_array($n,MYSQLI_ASSOC));
							if($n=='Food')
								echo '<img src="images/2f.jpg">';
							else if($n=='Technology')
								echo '<img src="images/2t.jpg">';
							else if($n=='Riding')
								echo '<img src="images/2r.jpg">';
							else if($n=='Sports')
								echo '<img src="images/2s.jpg">';
?>
</div>
